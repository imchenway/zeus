...
const zeus0388OpeningUserMessage: NativeConversationModelHistoryV2Item = {
  id: 'zeus-0388-user-message',
  sequence: 1,
  turnId: zeus0388LocalTurnId,
  submissionId: null,
  clientUserMessageId: 'zeus-0388-client-user-message',
  providerItemId: 'zeus-0388-user-message-provider-item',
  reasoningSummary: false,
  phase: null,
  segmentId: 'zeus-0388-segment',
  role: 'user',
  toolPairId: null,
  confirmedAt: '2026-08-29T03:45:00.000Z',
  content: {
    preview: '请完成三张原型图，并给出调研报告。',
    byteLength: 54,
    truncated: false,
    redacted: false,
    contentHandle: null,
...
const zeus0388CompletionOutput: NativeConversationModelHistoryV2Item = {
  ...
  recentClosedTurns: [
    {
      ...
      agentKind: 'codex',
      openingUserMessage: zeus0388OpeningUserMessage,
...
export function Zeus0388QaApp() {
  ...
  const authoritativeRefreshState = useMemo(
    () =>
