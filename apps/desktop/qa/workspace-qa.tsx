...
export function SourcePreviewQaApp() {
    ...
    return (
        <main className="macos-ai-app zeus-shell session-codex-parity-v1 qa-page qa-source-preview-page"
              data-theme="light" data-testid="source-preview-fixture">
            <header>
                <div>
            ...
            <div className="qa-source-preview-workspace">
                <SourceWorkspace preview={preview} viewMode={viewMode} onViewModeChange={setViewMode} language="zh-CN"
                                 fullWidth={fullWidth} onFullWidthChange={setFullWidth} onClose={() => undefined}/>
            </div>
        </main>
    );
}
