...
export const minimumMainWindowSize = { width: 640, height: 560 } as const;
...
export function createPersistedMainWindowState(input: { bounds: WindowBounds; display: WindowDisplaySnapshot; isMaximized: boolean; isFullScreen: boolean }): PersistedMainWindowState | undefined {
