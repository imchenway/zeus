                ...
                {expanded ? (
                  <div className="project-sidebar-conversations animated-project-menu">
                    ...
                    {conversationAttentionState !== 'idle' ? (
                      <span className="project-conversation-group-attention" title={conversationAttentionState === 'reply_required' ? copy.conversationReplyRequired : copy.conversationRunning}>
                        <SidebarConversationAttentionIndicator state={conversationAttentionState} />
                      </span>
                    ) : null}
                  </div>
                ) : null}
