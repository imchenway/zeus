...
export type TaskTableColumnKey = 'code' | 'intent' | 'taskType' | 'managementStatus' | 'runStatus' | 'source' | 'updatedAt' | 'createdAt' | 'template' | 'project' | 'priority' | 'description' | 'runtimeSession' | 'rawId' | 'createdFrom';
