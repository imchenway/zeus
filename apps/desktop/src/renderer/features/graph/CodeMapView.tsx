  ...
  const graphWorkbenchCopy =
    props.appLanguage === 'zh-CN'
      ? {
          ...
          drilldownFailed: '无法生成关联图，请查看错误详情',
          drilldownDepth: '关联层级',
          drilldownOne: '直接关联图',
          drilldownTwo: '间接关联图',
          ...
          staticStructure: '根据代码分析生成，不代表实际运行顺序',
        }
      : {
          ...
          focusAll: 'All',
          focusOne: 'Direct relationships',
          focusTwo: 'Indirect relationships',
          ...
          drilldownFailed: 'The relationship graph could not be generated. See the error details',
          drilldownDepth: 'Relationship depth',
          drilldownOne: 'Direct relationship graph',
          drilldownTwo: 'Indirect relationship graph',
          ...
          staticStructure: 'Generated from code analysis; does not show the actual execution order',
        };
