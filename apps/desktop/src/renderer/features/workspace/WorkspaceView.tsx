...
import { formatProjectDatabase, formatProjectDatabaseHelp, formatProjectDependencies, formatProjectLanguage, formatRuntimeAdapterDetectionFacts, formatRuntimeDefaultArgs, formatRuntimeTerminalEnv, InlineRecoveryPrompt, normalizeRuntimeSettingNumber, parseRuntimeDefaultArgsText, parseRuntimeTerminalEnvText, ProjectCreateDialog, ProjectWorkspaceModeToolbar, SidebarNav } from './WorkspaceChrome.js';
import { buildGitDiffDecisionSummary, buildGitHunkReviewKey, formatGitConfirmationExpiry, formatGitConfirmationStatus, formatGitOperationLabel, formatGraphConversationStatus, GENERIC_SHELL_CRITICAL_CONFIRMATION_PHRASE } from './workspaceFormatters.js';
import { handleInlineRailKeyboardNavigation, RuntimeXtermPane } from '../graph/GraphCanvas.js';
import { browserNativeConversationStartStorage, controlBusyProps, executionHostSupportsConversationSource, formatArchivedConversationDate, formatConfiguredTaskManagementStatus, formatProjectScanStatus, formatReleaseArtifactKind, formatReleaseAutoUpdateLabel, formatReleasePresenceStatus, formatReleaseUpdateChannel, formatReleaseUpdateLabel, formatReleaseUpdateReason, formatReleaseWaitingForItems, formatRuntimeAdapterDisplayName, formatRuntimeSessionStatus, NativeControlRow, NativeSettingsPane, PROJECT_SIDEBAR_MIN_WIDTH, ProjectArchiveWorkbench, type SettingsCategory, TaskCreateModal, TaskDeleteRelationshipDialog, TaskEnumOrderEditor, taskHierarchyDepth, TaskTableLayoutDecisionDialog, TaskTerminalCleanupDialog, workModeValues } from './workspaceSupport.js';
...
export function WorkspaceView(input: { state: WorkspaceQueryState; domainActions: WorkspaceDomainActions; operations: WorkspaceOperations }) {
  ...
  const { actionState, activeGraphView, activeNavTarget, activeProjectGraphSummary, activeProjectGraphSummaryBoundary, activeProjectId, activeProjectSection, activeTaskManagementStatusConfig, activeTaskManagementStatusLabels, activeTaskTableColumns, appShellSettings, archivedConversationLoadState, archivedConversations, archivedProjects, automaticUpdateIndicator, codeWorkspaceCopy, codexConfigImportError, codexConfigImportLoading, codexConfigImportPreview, codexConfigImportResult, codexLegacyImportBusy, codexLegacyImportError, codexLegacyImportLoading, codexLegacyImportSnapshot, codexUsageRevision, confirmingGitOperationBusy, conversationDrawer, creatingGitConfirmationBusy, creatingProjectBusy, creatingTaskBusy, currentProjectTasks, currentTaskConversationChoices, dataPortabilityStatusCopy, executingGitOperationBusy, expandedTaskIds, externalApiKeyInput, genericShellCriticalConfirmed, genericShellRisk, gitBaseRef, gitBranchName, gitCommitMessage, gitConfirmation, gitDiff, gitDiffCopy, gitHunkDecisions, gitLabel, gitOperationStatus, gitRemote, gitRollbackRef, gitStashRef, gitSwitchBranchName, gitTargetRef, graphAnswer, graphConversations, loadTaskBoard, loadingDiffBusy, loadingRuntimeBusy, loadingTemplatesBusy, localizedGenericShellRisk, nativeConversationGroups, nativeConversationRuntimeStates, nativeConversationStatusSyncState, nativeConversationTaskRunStatuses, orderedProjects, patchExportStatus, patchProjectConfigForm, patchProjectEditForm, pendingProjectDeleteId, projectCodeWorkspaceMode, projectConfig, projectConfigCopy, projectConfigForm, projectCreateDialogOpen, projectCreateError, projectCreateForm, projectCreationReady, projectDatabaseSecret, projectDetail, projectDirectoryChoosing, projectEditCopy, projectEditForm, projectPanel, projectSharedWritablePaths, projectSidebarResizing, projectSourceWorkspaceRef, projectWorkspaceConfigStatus, projectedRuntimeLogOutput, props, releaseStatus, releaseUpdateBusy, releaseUpdateCheckState, releaseUpdateStatus, restoringArchivedConversationId, runtime, runtimeAdapterChecks, runtimeAdapters, runtimeConfirmation, runtimeConfirmationStatusCopy, runtimeFavoriteOnly, runtimeGenericShellCommand, runtimeGenericShellCriticalConfirmation, runtimeInput, runtimeLogCopyStatusCopy, runtimeLogExportStatusCopy, runtimeLogSearchQuery, runtimeLogs, runtimeLogsCollapsed, runtimeSearchQuery, runtimeSessions, runtimeSettings, runtimeShowArchived, runtimeStatus, scanBusy, scanState, secondaryDrawerCopy, securityAuditLogs, securitySecrets, selectNoResults, selectSearchPlaceholder, selectedNativeConversation, selectedNativeConversationId, selectedProject, selectedTaskIds, sessionWorkspaceCopy, setActiveNavTarget, setActiveProjectSection, setAppShellSettings, setConversationDrawer, setExternalApiKeyInput, setGitBaseRef, setGitBranchName, setGitCommitMessage, setGitRemote, setGitRollbackRef, setGitStashRef, setGitSwitchBranchName, setGitTargetRef, setPendingProjectDeleteId, setProjectCreateError, setProjectCreateForm, setProjectPanel, setProjectSharedWritablePaths, setRuntimeConfirmation, setRuntimeConfirmationCommand, setRuntimeConfirmationStatus, setRuntimeFavoriteOnly, setRuntimeGenericShellCommand, setRuntimeGenericShellCriticalConfirmation, setRuntimeInput, setRuntimeLogSearchQuery, setRuntimeLogsCollapsed, setRuntimeSearchQuery, setRuntimeSettings, setRuntimeShowArchived, setSettingsCategory, setSourceWorkspaceDirty, setTaskConversationDrawerTarget, setTaskCreateForm, setTaskDeleteDialogTaskId, setTaskEvents, setTaskGitMergeTaskId, setTaskModelPushForm, setTaskSearchQuery, setTaskStatusSettingsTargetId, setTaskTableLayoutDraft, setTaskTableLayoutScopeDialogOpen, setTaskTagFilter, setTelegramAllowedUserIdsInput, setTelegramNotificationChatIdsInput, setTelegramTokenInput, settingsCategory, settingsWorkspaceCopy, snapshot, sourceWorkspaceLeaveDialogOpen, sourceWorkspaceSaveBusy, taskBoardLoadState, taskBoardSnapshots, taskBulkActionStatus, taskConversationDrawerReady, taskConversationDrawerTarget, taskCreateError, taskCreateForm, taskCreateModalOpen, taskCreateTitleInputRef, taskDeleteDialogTaskId, taskDetailPaneTaskId, taskDetailPresentation, taskGitDeliveryRevision, taskGitMergeTaskId, taskGitReviewState, taskModelPushAnnouncement, taskModelPushCapabilities, taskModelPushConfigImportNeedsActivation, taskModelPushConfigImportPreview, taskModelPushError, taskModelPushForm, taskModelPushRefreshingRepositoryId, taskModelPushRuntimeCapabilities, taskModelPushStatus, taskModelPushTaskId, taskPageViewMode, taskSearchQuery, taskStatusFilter, taskStatusFilterValues, taskTableLayoutDirty, taskTableLayoutLeaveDialogOpen, taskTableLayoutSaveBusy, taskTableLayoutScopeDialogOpen, taskTagFilter, taskTemplates, taskTerminalCleanupConfirmation, taskViewMode, taskWorkspaceCopy, telegramAllowedUserIdsInput, telegramNotificationChatIdsInput, telegramPollingLogs, telegramPollingStatus, telegramTestStatus, telegramTokenInput, uiCopy, updatingTaskBusy, visibleTasks, visitedCodeWorkspaceModes, workspaceScrollRef } = state;
  const { addTaskCreateAttachments, applyZentaoTaskExtract, archiveConversation, authorizeTaskCreateFiles, cancelTaskModelPushAuthentication, cancelTaskModelPushCodexConfigImport, changedFiles, chooseProjectDirectoryForCreate, closeProjectCreateDialog, closeTaskCreateModal, closeTaskGitReview, closeTaskModelPush, codeMapActionLabel, createCurrentProject, currentRuntimeAdapterDisplayName, deleteProject, effectiveTaskStatusSettingsTargetId, importTaskModelPushCodexConfig, loadGraphConversationDetail, loadProjectConfig, loadProjectWorkspaceConfig, materializeTaskCreateResources, openProjectCreateDialog, openTaskConflictAiConversation, openTaskConversationDrawer, openTaskCreateModal, openTaskDetailPane, openZentaoLinkInBrowser, persistCodeWorkspacePreference, prepareNewConversationDraft, readTaskCreateClipboardResources, refreshArchivedConversations, refreshArchivedProjects, refreshNativeConversationChoices, refreshTaskModelPushRepository, removeTaskCreateAttachment, renameProjectDisplayName, resolveTaskTerminalCleanupConfirmation, restoreProject, restoreTaskConversation, revealProjectInFinder, saveProjectConfig, saveProjectWorkspaceConfig, scanActiveProjectGraph, selectNativeConversation, selectProjectCodeWorkspaceMode, skipTaskModelPushCodexConfigImport, submitTaskCreateModal, submitTaskModelPush, taskDetailPaneTask, taskPriorityLabels, taskStatusSettingsConfig, taskStatusSettingsUsageCounts, taskTableEnumSortOrders, updateProject, updateTaskContent, updateTaskCreateForm, updateTaskCreatePriority, updateTaskCreateType, updateTaskManagementStatus } = domainActions;
  const { activateCodexConfig, archiveRuntimeSession, beginSaveTaskTableLayoutAndLeave, cancelSourceWorkspaceLeave, cancelTaskTableLayoutLeave, cancelTaskTableLayoutScopeDialog, checkReleaseUpdate, checkRuntimeAdapter, clearExternalApiKey, clearLocalCaches, clearNetworkCache, clearTaskSelection, clearTelegramBotToken, closeTaskDetail, confirmAndStartGenericRuntime, confirmGitOperation, copyRuntimeLogs, createGenericRuntimeConfirmation, createGitConfirmation, createTaskFromRuntimeSession, createTaskFromTemplate, deleteRuntimeSession, deleteTaskWithRelationshipStrategy, discardSourceWorkspaceAndLeave, discardTaskTableLayoutAndLeave, executeConfirmedGitOperation, exportGitPatch, exportLocalSettings, exportRuntimeLogs, generateRuntimeSessionSummary, handleCodeMapAction, handleMainNavigate, handleProjectSidebarResizeKeyDown, handleProjectSidebarResizePointerDown, handleWindowDragPointerDown, importCodexConfig, importLocalSettings, interruptRuntimeSession, loadGitDiff, loadRuntimeStatus, loadRuntimeTerminalSnapshot, loadTaskTemplates, moveTaskBoardTask, openProjectSection, projectDrawerVisualProps, projectSidebarMaximumWidth, projectSidebarShellStyle, projectSidebarWidth, refreshCodexConfigImport, refreshCodexLegacyImports, refreshRuntimeSessions, rejectGenericRuntimeConfirmation, rejectGitOperation, renderNativeConversationWorkspace, renderProjectCodeMapStage, renderTaskDetailPaneContent, repositoryPickerLabel, resetProjectSidebarWidth, resetSecurity, resizeRuntimeSession, restoreRuntimeSession, runBulkTaskDelete, runBulkTaskStatusChange, saveAppShellSettings, saveExternalApiKey, saveRuntimeSettings, saveSourceWorkspaceAndLeave, saveTaskPageViewMode, saveTaskStatusFilter, saveTaskTableLayout, saveTaskViewPreferences, saveTelegramBotToken, saveTelegramNotificationSettings, saveTelegramSecuritySettings, sendRuntimeInput, setGitHunkDecision, setRuntimeSessionFavorite, startCodexLegacyImport, startRuntimeSession, stopRuntimeSession, testTelegramConnection, toggleAllVisibleTaskSelection, toggleCollapsedProject, togglePinnedProject, toggleSidebarConversationOrganization, toggleSidebarConversationStatusGroup, toggleTaskSelection, updateTaskBoardSettings, updateTaskManagementStatusConfigDraft, workspaceDrawerPortalStyle } = operations;
return (
    <main
