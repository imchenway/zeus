...
import { renderTaskPushLayoutText, type ProjectCodeWorkspacePreference, type ZentaoTaskExtract } from '@zeus/shared';
...
import { loadLegacyConversationDetail, nativeConversationChoiceFromAcceptance, type NativeConversationStartFailure, preloadCodexConversationCapabilities, readCachedCodexConversationCapabilities, type NativeConversationStartPreparation, type ProjectSessionWorkspaceStartInput, type SessionWorkspaceActions, type SessionWorkspaceStartInput, startNativeConversationWithDurableAcceptance, startProjectConversationWithDurableAcceptance } from '../../session/SessionWorkspace.js';
import type { CodexTaskPushCapabilities, NativeConversationAttachment, NativeConversationChoice, NativeConversationChoicesSnapshot, NativeProjectConversationChoicesSnapshot, NativeTurnSettingsSelection, StartTaskModelPushRequest } from '../../session/sessionTypes.js';
...
import { buildTaskModelPushLayout, normalizeTaskModelPushCapabilities, readTaskModelPushPreferences, resolveTaskModelPushInitialForm, selectedTaskPushCurrentConversationPaths, selectedTaskPushParentContexts, selectedTaskPushRelatedContexts, type TaskModelPushForm, taskPushSupplementalLayoutAttachments, taskPushSupplementalRequestAttachments, writeTaskModelPushPreferences } from '../../task/TaskModelPushModal.js';
import { acceptTaskModelPushPendingState, attachTaskModelPushChoice, createTaskModelPushPendingState, enqueueTaskModelPushMessage, failTaskModelPushPendingState, retryTaskModelPushPendingState, taskModelPushHasRealChoice, type TaskModelPushPendingState, updateTaskModelPushAttachments, updateTaskModelPushDeferredMessages, updateTaskModelPushDraft } from '../../task/TaskModelPushPendingWorkspace.js';
...
import { type DashboardSnapshot, type GraphConversationHistoryItem, type GraphSearchResult, type GraphViewSnapshot, type GraphViewType, type ProjectGitAction, type ProjectGitActionResponse, type ProjectRecord, type SaveProjectConfigRequest, type TaskBoardOpenMode, type TaskManagementStatus, type TaskPriority, type TaskRecord, type TaskType, type UpdateTaskRelationshipsRequest, type UpdateTaskRequest, ZeusApiError, type ZeusRealtimeConnectionState, type ZeusRealtimeEvent } from '../../apiClient.js';
...
import { appendRuntimeOutputEventsToConversation, applyRuntimeEndedEventToConversation, beginNativeConversationChoiceTaskLoad, browserNativeConversationStartStorage, buildTaskCreateInitialForm, completeNativeConversationChoiceTaskLoad, defaultProjectNameFromLocalPath, executionHostSupportsConversationSource, failNativeConversationChoiceTaskLoad, formatConfiguredTaskManagementStatus, formatRuntimeAdapterDisplayName, getLanguageCopy, isDefinitiveNativeConversationStartRejection, isProjectConversationAttentionState, isProjectGraphViewForProject, isRuntimeConversationOutputEvent, type NativeConversationAppClient, normalizeCodeWorkspaceByProject, normalizeProjectLocalPath, normalizeRendererAppShellSettings, normalizeTaskCreateDraft, type ProjectCodeWorkspaceMode, readCodexConfigImportPromptPreference, resolveConversationNavigationId, resolveTaskManagementStatusConfig, selectCreatedGraphNodeTask, selectCreatedProjectTask, shouldRefreshConversationForRuntimeEvent, shouldRefreshNativeConversationListForRealtimeEvent, type TaskCreateAttachment, type TaskCreateAttachmentCandidate, type TaskCreateDraft, type TaskCreateTextField, toAppShellSettingsSavePayload, type TrackedTaskModelPushState, upsertProjectConversationChoiceSnapshot, upsertTaskConversationChoiceSnapshot, writeCodexConfigImportPromptPreference } from './workspaceSupport.js';
...
export function useWorkspaceDomainActions(state: WorkspaceQueryState) {
  const { actionState, activeGraphView, activeGraphViewTypeRef, activeNavTarget, activeProjectId, activeProjectIdRef, activeProjectSection, activeTaskManagementStatusIds, appShellSettings, appShellSettingsRef, archivedConversationRefreshPromiseRef, codeWorkspaceCopy, codeWorkspacePreferenceTimerRef, conversationDraftOpen, conversationNotificationRef, createProjectConfigForm, creatingProjectBusy, gitDiff, graphConversationDetailRequestVersionRef, graphConversationListRequestVersionRef, graphConversationPage, graphConversationTaskIdentityRef, graphConversations, graphNodeTaskIdentityRef, graphProjectId, graphQuestionRequestVersionRef, graphScanRequestVersionRef, graphSearchRequestVersionRef, graphViewRequestVersionRef, loadTaskBoard, mergeTaskRecord, nativeConversationChoiceLoadCoordinator, nativeConversationChoiceTaskStates, nativeConversationChoicesByProjectRef, nativeConversationChoicesByTask, nativeConversationChoicesByTaskRef, nativeConversationRuntimeStates, nativeConversationStartEnvelopeManager, nativeLegacyMessages, nativeProjectConversationChoiceLoadCoordinator, pendingRealtimeNativeConversationRefreshIdsRef, pendingRealtimeTaskRefreshIdsRef, projectConfigForm, projectConversationStartEnvelopeManager, projectCreateForm, projectCreateReturnFocusRef, projectCreationReady, projectDetail, projectDirectoryChoosing, projectEditForm, projectSharedWritablePaths, projectSourceWorkspaceRef, projectTaskModelPushManagementStatus, projectedTaskConversationChoices, props, reconcileNativeConversationProjectSnapshot, reconcileNativeConversationProjectionStates, repeatRealtimeNativeConversationRefreshIdsRef, restoringArchivedConversationId, runtimeAdapters, runtimeSettings, scanBusy, scanState, selectedNativeConversationIdRef, selectedProject, selectedTaskConversationRef, setActionState, setActiveNavTarget, setActiveProjectSection, setAppShellSettings, setArchivedConversationLoadState, setArchivedConversations, setArchivedProjects, setCodexUsageRevision, setConversationDraftOpen, setConversationDrawer, setFocusedArchivedConversation, setGraphAnswer, setGraphConversationPage, setGraphConversations, setGraphNodeTaskFeedback, setGraphProjectId, setGraphSearchResult, setGraphSourceOpenFeedback, setGraphView, setLastGraphNodeTaskId, setLocalError, setNativeConversationChoiceProjectStates, setNativeConversationChoiceTaskStates, setNativeConversationChoicesByProject, setNativeConversationChoicesByTask, setNativeConversationRuntimeStates, setNativeConversationStatusSyncState, setNativeLegacyConversationDetails, setNativeLegacyMessageError, setNativeLegacyMessageLoadState, setNewConversationFocusRequest, setOptimisticTerminalTaskStatuses, setPendingProjectDeleteId, setProjectCodeWorkspaceMode, setProjectConfig, setProjectConfigForm, setProjectCreateDialogOpen, setProjectCreateError, setProjectCreateForm, setProjectDetail, setProjectDirectoryChoosing, setProjectEditForm, setProjectSharedWritablePaths, setProjectWorkspaceConfigError, setProjectWorkspaceConfigStatus, setRestoringArchivedConversationId, setScanState, setSelectedGraphConversation, setSelectedNativeConversationId, setSelectedTaskIds, setSnapshot, setTaskConversationDrawerTarget, setTaskConversationReopenState, setTaskCreateError, setTaskCreateForm, setTaskCreateModalOpen, setTaskDetail, setTaskDetailPaneTaskId, setTaskDetailPresentation, setTaskEvents, setTaskGitDeliveryRevision, setTaskGitMergeTaskId, setTaskGitReviewState, setTaskModelPushAnnouncement, setTaskModelPushCapabilities, setTaskModelPushConfigImportNeedsActivation, setTaskModelPushConfigImportPreview, setTaskModelPushError, setTaskModelPushForm, setTaskModelPushRefreshingRepositoryId, setTaskModelPushRuntimeCapabilities, setTaskModelPushStatus, setTaskModelPushTaskId, setTaskSearchQuery, setTaskTagFilter, setTaskTerminalCleanupConfirmation, setVisitedCodeWorkspaceModes, settingsWorkspaceCopy, sidebarConversationPreferenceSaveQueueRef, snapshot, taskCreateForm, taskCreateReturnFocusRef, taskCreateTitleInputRef, taskCreationIdentityRef, taskDetail, taskDetailPaneTaskId, taskGitDeliveryChangedRef, taskGitDeliveryConversationRef, taskGitReviewState, taskLocalVersionTransitionsRef, taskManagementStatusReplacementsRef, taskModelPushCapabilities, taskModelPushCapabilityRequestRef, taskModelPushConfigImportNeedsActivation, taskModelPushConfigImportPreview, taskModelPushDeferredDispatchingTaskIdsRef, taskModelPushDispatchingTaskIdsRef, taskModelPushEnvelopeRef, taskModelPushForm, taskModelPushLoginIdRef, taskModelPushLoginRequestRef, taskModelPushNavigationRef, taskModelPushPendingByTask, taskModelPushPendingByTaskRef, taskModelPushRefreshingRepositoryId, taskModelPushStatus, taskModelPushTaskId, taskMutationQueuesRef, taskStatusSettingsTargetId, taskTerminalCleanupConfirmation, taskWorkspaceCopy, uiCopy, updateTaskModelPushPendingByTask, visibleTasks, workspaceScrollRef } = state;
const persistCodeWorkspacePreference = useCallback(
    ...
    const unsubscribe = subscribeRealtimeEvents(
      (event) => {
        if (event.type === 'storage.write_fault') {
          reportStorageReadOnlyFault(appShellSettings.appLanguage === 'zh-CN' ? 'zh-CN' : 'en', event.payload.readsAvailable === true, (error) =>
  ...
  return { acknowledgeNativeConversationAttention, addTaskCreateAttachments, applyZentaoTaskExtract, archiveConversation, archiveGraphConversation, askGraph, authorizeTaskCreateFiles, cancelTaskModelPushAuthentication, cancelTaskModelPushCodexConfigImport, changedFiles, chooseNativeConversationAttachments, chooseProjectDirectoryForCreate, closeProjectCreateDialog, closeTaskCreateModal, closeTaskGitReview, closeTaskModelPush, codeMapActionLabel, createCurrentProject, createTaskFromGraphConversation, createTaskFromGraphNode, currentRuntimeAdapterDisplayName, deleteProject, effectiveTaskStatusSettingsTargetId, executeNewConversationProjectGit, importTaskModelPushCodexConfig, loadGraphConversationDetail, loadGraphConversations, loadProjectConfig, loadProjectWorkspaceConfig, materializeTaskCreateResources, openGraphSourceFromCodeMap, openGraphView, openProjectCreateDialog, openTaskConflictAiConversation, openTaskConversation, openTaskConversationDrawer, openTaskCreateModal, openTaskDetailPane, openTaskGitDelivery, openTaskModelPush, openZentaoLinkInBrowser, persistCodeWorkspacePreference, persistSidebarConversationPreferences, prepareNewConversationDraft, readTaskCreateClipboardResources, recordLocalError, recordTaskMutationVersion, refreshArchivedConversations, refreshArchivedProjects, refreshNativeConversationChoices, refreshOpenTaskEvents, refreshTaskModelPushRepository, removeTaskCreateAttachment, renameProjectDisplayName, reopenTaskFromConversation, requestTaskTerminalCleanupConfirmation, resetGraphWorkspace, resolveTaskTerminalCleanupConfirmation, restoreGraphConversation, restoreProject, restoreTaskConversation, retryTaskModelPush, revealProjectInFinder, saveProjectConfig, saveProjectWorkspaceConfig, scanActiveProjectGraph, searchGraph, selectNativeConversation, selectNewConversationProject, selectProjectCodeWorkspaceMode, skipTaskModelPushCodexConfigImport, startNativeConversation, startProjectConversation, submitTaskCreateModal, submitTaskModelPush, taskDetailPaneConversationState, taskDetailPaneConversations, taskDetailPaneModelPushView, taskDetailPaneTask, taskModelPushWorkspaceActions, taskPriorityLabels, taskStatusSettingsConfig, taskStatusSettingsUsageCounts, taskTableEnumSortOrders, updateProject, updateTaskContent, updateTaskCreateForm, updateTaskCreatePriority, updateTaskCreateType, updateTaskManagementStatus, updateTaskRelationships };
}
