...
import { type AiRuntimeSession, type DeleteTaskRequest, type GitDiffHunk, type HighRiskGitOperation, type ProjectRecord, type TaskBoardMoveRequest, type TaskBoardViewSettings, type TaskBoardViewSnapshot, type TaskManagementStatus, type TaskPageViewMode, type TaskRecord, type TaskStatusFilter, ZeusApiError } from '../../apiClient.js';
...
import { adjustProjectSidebarWidthForKeyboard, browserNativeConversationStartStorage, buildRuntimeSessionTaskDraft, clampProjectSidebarWidth, createSessionWorkspaceTask, formatConfiguredTaskManagementStatus, mergeAppShellSettingsSaveResponse, normalizeProjectSidebarPreferredWidth, normalizeRendererAppShellSettings, normalizeTaskStatusFilterByProject, persistProjectSidebarPreferredWidth, PROJECT_SIDEBAR_DEFAULT_WIDTH, PROJECT_SIDEBAR_MAX_WIDTH, type ProjectCodeWorkspaceMode, type ProjectSidebarDragState, type ProjectWorkspaceSection, resolveTaskManagementStatusConfig, resolveTaskTableColumnsForProject, toAppShellSettingsSavePayload, transitionProjectSidebarDrag, type WorkspaceViewId } from './workspaceSupport.js';
...
export function useWorkspaceOperations(state: WorkspaceQueryState, domainActions: WorkspaceDomainActions) {
  const { actionState, activeGraphView, activeNavTarget, activeProjectId, activeProjectIdRef, activeProjectSection, activeTaskManagementStatusConfig, activeTaskManagementStatusLabels, activeTaskTableColumns, appShellSettings, appShellSettingsRef, codeMapSettings, codeWorkspaceCopy, codexConfigImportResult, conversationDraftOpen, currentProjectTasks, expandedTaskIds, externalApiKeyInput, firstProjectId, genericShellCriticalConfirmed, gitBaseRef, gitBranchName, gitCommitMessage, gitConfirmation, gitDiffCopy, gitRemote, gitRollbackRef, gitStashRef, gitSwitchBranchName, gitTargetRef, graphAnswer, graphConversationPage, graphConversationSearch, graphConversations, graphNodeTaskFeedback, graphSearchResult, graphSourceOpenFeedback, lastGraphNodeTaskId, loadTaskBoard, mergeTaskRecord, nativeConversationHotCacheRef, nativeLegacyMessageError, nativeLegacyMessageLoadState, nativeLegacyMessages, nativeSessionChoiceTaskState, nativeSessionChoices, nativeSessionOwner, nativeSessionTask, nativeSessionTaskReadOnly, newConversationFocusRequest, optimisticTerminalTaskStatuses, pendingSourceWorkspaceLeaveCancelRef, pendingSourceWorkspaceLeaveRef, pendingTaskTableLayoutLeaveCancelRef, pendingTaskTableLayoutLeaveRef, persistedTaskTableColumns, projectCodeWorkspaceMode, projectPanel, projectSidebarCommittedWidthRef, projectSidebarDragCleanupRef, projectSidebarPreferredWidth, projectSidebarViewportWidth, projectSourceWorkspaceRef, props, recordNativeConversationRuntimeState, runtime, runtimeConfirmation, runtimeConfirmationCommand, runtimeFavoriteOnly, runtimeGenericShellCommand, runtimeInput, runtimeLogs, runtimeSearchQuery, runtimeSettings, runtimeShowArchived, runtimeTaskIdentityRef, saveTaskTableLayoutThenLeaveRef, scanState, selectedGraphConversation, selectedNativeConversation, selectedProject, selectedTaskModelPushOperation, selectedTaskModelPushOptimisticState, sessionWorkspaceCopy, setActionState, setActiveNavTarget, setActiveProjectSection, setAppShellSettings, setCodeMapSettings, setCodexConfigImportError, setCodexConfigImportLoading, setCodexConfigImportPreview, setCodexConfigImportResult, setCodexLegacyImportBusy, setCodexLegacyImportError, setCodexLegacyImportLoading, setCodexLegacyImportSnapshot, setConversationDraftOpen, setDataPortabilityStatus, setExternalApiKeyInput, setGitConfirmation, setGitDiff, setGitHunkDecisions, setGitOperationStatus, setGraphConversationSearch, setLatestConversationContentVisible, setPatchExportStatus, setProjectCodeWorkspaceMode, setProjectConfig, setProjectConfigForm, setProjectDetail, setProjectPanel, setProjectSidebarPreferredWidth, setProjectSidebarResizing, setReleaseStatus, setReleaseUpdateCheckState, setReleaseUpdateStatus, setRuntimeAdapterChecks, setRuntimeAdapters, setRuntimeConfirmation, setRuntimeConfirmationCommand, setRuntimeConfirmationStatus, setRuntimeInput, setRuntimeLogCopyStatus, setRuntimeLogExportStatus, setRuntimeLogs, setRuntimeSessions, setRuntimeSettings, setRuntimeStatus, setSecurityAuditLogs, setSecuritySecrets, setSelectedTaskIds, setSettingsCategory, setSnapshot, setSourceWorkspaceLeaveDialogOpen, setSourceWorkspaceSaveBusy, setTaskBoardSnapshots, setTaskBulkActionStatus, setTaskDeleteDialogTaskId, setTaskDetail, setTaskDetailPaneTaskId, setTaskDetailPresentation, setTaskEvents, setTaskGitReviewState, setTaskManagementStatusReplacements, setTaskTableLayoutDraft, setTaskTableLayoutLeaveDialogOpen, setTaskTableLayoutSaveBusy, setTaskTableLayoutScopeDialogOpen, setTaskTemplates, setTelegramAllowedUserIdsInput, setTelegramNotificationChatIdsInput, setTelegramNotificationSettings, setTelegramPollingStatus, setTelegramSecuritySettings, setTelegramTestStatus, setTelegramTokenInput, setVisitedCodeWorkspaceModes, settingsWorkspaceCopy, snapshot, sourceWorkspaceDirty, taskBoardSnapshots, taskConversationReopenState, taskDetailPaneTaskId, taskEvents, taskManagementStatusReplacements, taskPageViewMode, taskStatusFilter, taskTableLayoutDirty, taskViewMode, taskWorkspaceCopy, telegramAllowedUserIdsInput, telegramNotificationChatIdsInput, telegramNotificationSettings, telegramSecuritySettings, telegramTokenInput, templateTaskIdentityRef, uiCopy, updatingTaskBusy, visibleTasks, workspaceScrollRef } = state;
  const { archiveGraphConversation, askGraph, chooseNativeConversationAttachments, createTaskFromGraphConversation, createTaskFromGraphNode, effectiveTaskStatusSettingsTargetId, executeNewConversationProjectGit, loadGraphConversationDetail, loadGraphConversations, loadProjectConfig, openGraphSourceFromCodeMap, openGraphView, openTaskConversation, openTaskCreateModal, openTaskGitDelivery, openTaskModelPush, persistSidebarConversationPreferences, recordLocalError, recordTaskMutationVersion, refreshNativeConversationChoices, refreshOpenTaskEvents, reopenTaskFromConversation, requestTaskTerminalCleanupConfirmation, restoreGraphConversation, retryTaskModelPush, scanActiveProjectGraph, searchGraph, selectNewConversationProject, selectProjectCodeWorkspaceMode, startNativeConversation, startProjectConversation, taskDetailPaneConversationState, taskDetailPaneConversations, taskDetailPaneModelPushView, taskDetailPaneTask, taskModelPushWorkspaceActions, updateTaskContent, updateTaskManagementStatus, updateTaskRelationships } = domainActions;
