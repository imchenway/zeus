...
import { type AiRuntimeAdapterDescriptor, type AiRuntimeAdapterStatus, type AiRuntimeLogEntry, type AiRuntimeSession, type AiRuntimeTerminalEvent, type AiRuntimeTerminalSnapshot, type AppShellSettings, type CodeMapSettings, type CodexConfigActivationResult, type CodexConfigImportPreview, type CodexConfigImportResult, type CodexLegacyImportResult, type CodexLegacyImportSnapshot, type CreateProjectRequest, type DashboardClient, type DashboardSnapshot, type DeleteTaskRequest, type ExecutedGitOperationResult, type ExecuteGitOperationRequest, type ExecutionHostTransition, type GitDiffSummary, type GitOperationConfirmation, type GitPatchExport, type GraphConversationHistoryItem, type GraphConversationHistoryPage, type GraphNeighborhood, type GraphQuestionAnswer, type GraphSearchResult, type GraphViewSnapshot, type GraphViewType, type HighRiskGitOperation, type ImportLocalBusinessDataResult, type ImportLocalSettingsRequest, type ImportLocalSettingsResult, type LoadRuntimeSessionsRequest, type LocalBusinessDataSnapshot, type LocalSettingsExportSnapshot, type ProjectArchiveConfirmation, type ProjectConfig, type ProjectDatabaseSecretSnapshot, type ProjectRecord, type ReleaseStatusSnapshot, type ReleaseUpdateStatusSnapshot, type RuntimeOperationConfirmation, type RuntimeSettings, type RuntimeStatusSnapshot, type SaveProjectConfigRequest, type SecurityAuditLogEntry, type SecurityResetResult, type SecuritySecretsSnapshot, type SendConversationMessageResult, type TaskEventRecord, type TaskManagementStatus, type TaskRecord, type TaskStatus, type TaskTemplateRecord, type TelegramNotificationSettings, type TelegramPollingLogEntry, type TelegramPollingStatus, type TelegramSecuritySettings, type TelegramTestConnectionResult, type UpdateTaskRelationshipsRequest, type UpdateTaskRequest, type ZeusRealtimeConnectionState, type ZeusRealtimeEvent } from '../../apiClient.js';
import { type AppShellSettingsSavePayload, type LegacyMainNavTarget, type LocalUiErrorSnapshot, type MainNavTarget, type NativeConversationAppClient, type SettingsCategory, type TaskCreateAttachmentCandidate, type TaskCreateDraft, type TaskRuntimeControlHandlerResult } from './workspaceSupport.js';
