...
export const languageCopy = {
  'zh-CN': {
    ...
    sidebar: {
      ...
      addProject: '新增项目',
      filterConversationsByTaskStatus: '按会话的任务状态筛选',
      ...
      hideEmptyFilteredProjectsLabel: '隐藏无匹配项目',
      hideEmptyFilteredProjects: '隐藏无匹配会话的项目',
  ...
  'en-US': {
    ...
    sidebar: {
      ...
      filterConversationsByTaskStatus: 'Filter conversations by task status',
      /** 英文界面沿用相同的筛选操作与分区语义。 */
      ...
      hideEmptyFilteredProjectsLabel: 'Hide empty projects',
      hideEmptyFilteredProjects: 'Hide projects without matching conversations',
