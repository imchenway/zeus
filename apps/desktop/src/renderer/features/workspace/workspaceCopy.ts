...
export const languageCopy = {
  'zh-CN': {
    ...
    taskWorkspace: {
      ...
      taskActionChecking: '正在检查…',
      taskActionRetry: '重新检查',
      taskActionCodeDelivery: '代码交付…',
      taskActionDelete: '删除任务…',
      taskActionTerminalHelp: '重新打开任务后可推送到新会话',
  ...
  'en-US': {
    ...
    taskWorkspace: {
      ...
      taskActionChecking: 'Checking…',
      taskActionRetry: 'Check again',
      taskActionCodeDelivery: 'Code delivery…',
      taskActionDelete: 'Delete task…',
      taskActionTerminalHelp: 'Reopen the task before pushing it to a new conversation.',
