...
export const languageCopy = {
  'zh-CN': {
    ...
    codeWorkspace: {
      ...
      waitingRealScan: '尚未扫描',
      emptyGraphHelp: '扫描项目后，可以查看文件之间的关系和代码结构。',
      ...
      projectConfig: {
        ...
        defaultTaskPromptHelp: '用于项目内的图谱问答；发送任务给 AI 时不会附带这段提示。',
        ...
        localSchemaHelp: '配置的数据库结构文件也会加入代码图谱，即使文件不在 src 目录中。',
      },
    },
    settingsWorkspace: {
      viewAria: '设置',
    ...
    codeMapWorkspace: {
      ...
      title: '代码图谱',
      sourceSummary: '图谱来自项目源码，展示代码之间的关系。',
      contextFactsAria: '代码图谱信息',
      realSource: '来源',
      currentView: '当前视图',
      ...
      askGraphTitle: '向图谱提问',
      askGraphHelp: 'AI 根据当前代码图谱回答问题；资料不足时会说明缺少什么。',
      questionAria: '图谱问题输入',
      questionTitle: '问题',
      questionHelp: '针对当前代码图谱提问',
      ...
      edgeSource: '边来源',
      lineLabel: '行',
      missingSymbol: '未关联代码符号',
      graphCanvas: '代码图谱画布',
      sequenceGraphCanvas: '时序图画布',
      canvasEmpty: '没有符合当前筛选条件的节点，请调整搜索或筛选。',
      aggregatedEdges: '聚合边',
      ...
      graphNodeTaskCreateFailed: '未能从这个节点创建任务，请查看错误原因。',
      ...
      searchHistoryHelp: '搜索已有问答记录',
      searchHistoryAction: '搜索历史',
      viewActiveHistory: '查看未归档',
      viewArchivedHistory: '查看归档',
      realQaCount: (count: number) => `${count} 条问答`,
      qaHistoryEmptyAria: '图谱问答历史空态',
      noRealQaHistory: '暂无问答记录',
      noMatchingQaHistory: '没有匹配的问答记录，请调整关键词或清除筛选。',
      ...
      mermaidPreviewHelp: '导出当前可见的图谱。Mermaid 和 PlantUML 是可在其他工具中编辑的图表文本格式。',
      ...
      mermaidEmptyHelp: '点击生成，预览当前筛选结果的图表源码。',
      ...
      realNodeCount: (count: number) => `${count} 个节点`,
      sourceCount: (count: number) => `${count} 个来源`,
      aggregatedNodeSummary: (count: number, sourceCount: number) => `包含 ${count} 个节点 · ${sourceCount} 个来源`,
      ...
      graphEdgesAria: '图谱边',
      graphEdgesTitle: '图谱边',
      realEdgeCount: (count: number) => `${count} 条关系`,
      aggregatedEdgeSummary: (count: number, sourceCount: number) => `包含 ${count} 条关系 · ${sourceCount} 个来源`,
  ...
  'en-US': {
    ...
    sessionWorkspace: {
      ...
      secondaryDrawer: {
        ...
        graphContextHelp: 'Code structure of this project',
    ...
    codeWorkspace: {
      ...
      waitingRealScan: 'Not scanned',
      emptyGraphHelp: 'Scan the project to see its code structure and relationships between files.',
      ...
      projectConfig: {
        ...
        defaultTaskPromptHelp: 'Used for project graph questions. This text is not included when sending a task to the AI.',
        ...
        localSchemaHelp: 'Configured database schema files are included in the code graph even when they are outside src.',
      },
    },
    settingsWorkspace: {
      viewAria: 'Settings',
    ...
    codeMapWorkspace: {
      ...
      title: 'Code graph',
      sourceSummary: 'The graph is built from project source code and shows relationships in the code.',
      contextFactsAria: 'Code graph information',
      realSource: 'Source',
      ...
      realNodes: 'Nodes',
      realEdges: 'Relationships',
      primaryGridAria: 'Code graph and details',
      stageAria: 'Code graph',
      inspectorAria: 'Selected item details',
      ...
      askGraphHelp: 'The AI answers using the current code graph and explains when source material is insufficient.',
      questionAria: 'Graph question input',
      questionTitle: 'Question',
      questionHelp: 'Ask about the current code graph',
      ...
      lineLabel: 'Line',
      missingSymbol: 'No linked code symbol',
      graphCanvas: 'Code graph canvas',
      sequenceGraphCanvas: 'Sequence diagram canvas',
      canvasEmpty: 'No nodes match the current filters. Adjust the search or filters.',
      ...
      graphNodeTaskCreateFailed: 'A task could not be created from this node. Check the error for the cause.',
      ...
      searchHistoryHelp: 'Search existing questions and answers',
      searchHistoryAction: 'Search history',
      viewActiveHistory: 'View active',
      viewArchivedHistory: 'View archived',
      realQaCount: (count: number) => `${count} questions and answers`,
      qaHistoryEmptyAria: 'Q&A history empty state',
      noRealQaHistory: 'No questions and answers yet',
      noMatchingQaHistory: 'No matching questions or answers. Change the search or clear the filters.',
      ...
      mermaidPreviewHelp: 'Export the visible graph as Mermaid or PlantUML, text formats that can be edited in other diagram tools.',
      ...
      mermaidEmptyHelp: 'Generate a preview of the diagram source for the current filtered graph.',
      ...
      realNodeCount: (count: number) => `${count} nodes`,
      sourceCount: (count: number) => `${count} source${count === 1 ? '' : 's'}`,
      aggregatedNodeSummary: (count: number, sourceCount: number) => `Contains ${count} nodes · ${sourceCount} sources`,
      ...
      realEdgeCount: (count: number) => `${count} relationships`,
      aggregatedEdgeSummary: (count: number, sourceCount: number) => `Contains ${count} relationships · ${sourceCount} sources`,
      ...
      oneHopNeighbors: 'Directly related items',
      twoHopImpact: 'Indirectly related items',
      riskTags: 'Risk tags',
      nodeActions: {
        ...
        expandOneHop: 'Expand direct relationships',
        expandTwoHop: 'Expand indirect relationships',
