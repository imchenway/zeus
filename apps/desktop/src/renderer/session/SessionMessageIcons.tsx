  ...
  return (
    <svg {...iconProps(svgProps)} fill={selected ? 'currentColor' : 'none'}>
      <g transform={direction === 'down' ? 'rotate(180 12 12)' : undefined}>
        <path d="M8 10.1 11.1 4.4c.42-.78 1.58-.62 1.78.24.13.56.19 1.14.19 1.72 0 1.08-.24 2.14-.69 3.12h5.23a2.1 2.1 0 0 1 2.04 2.58l-1.3 5.55a2.65 2.65 0 0 1-2.58 2.04H8Z" />
