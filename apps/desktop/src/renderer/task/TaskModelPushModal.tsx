...
export function TaskModelPushModal(props: {
  ...
  const busy = authenticating || authenticated || props.status === 'submitting';
              ...
              <p>
                {authenticated
                  ...
                  : authenticating
                    ...
                    : zh
                      ? '点击“登录并继续”会打开官方登录页。完成后无需点击网页中的其他按钮，Zeus 会自动返回；当前模型、工作区和补充信息都会保留。'
                      : 'Choose “Sign in and continue” to open the official sign-in page. You do not need to choose another button there; Zeus will return automatically and preserve your configuration.'}
              </p>
            </section>
          ) : null}
