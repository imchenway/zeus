...
async function verifyImportBoundaries(): Promise<void> {
  ...
  const modularPolicies: Record<string, string[]> = {
    ...
    'packages/local-server/src/projectQueryApplication.ts': ['@zeus/git-core', '@zeus/project-core', '@zeus/storage'],
    ...
    'packages/local-server/src/codexSubagentQueryApplication.ts': ['@zeus/ai-runtime', '@zeus/storage', './conversationResources.js'],
