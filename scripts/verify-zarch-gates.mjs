...
const checks = [
  ...
  { id: 'conversation-start-command-behavior', command: 'pnpm', args: ['exec', 'tsx', 'scripts/verify-conversation-start-command-behavior.ts'] },
  { id: 'conversation-start-command-slice', command: 'node', args: ['scripts/audit-command-side-effect-entries.mjs', '--require-conversation-start-create-command-slice'] },
